...
var budgetController = (function () {
  ...
  // All Object Instances Will be Added Here
  var data = {
    allItems: {
      exp: [],
      inc: [],
  ...
  // This public object allow us to create instances of both Income and Expense Constructor
  return {
    addItem: function (type, des, val) {
      ...
      // We First Select the arr type based on either exp/inc, and then we select the last element

      // Create new unique ID for both inc and exp
...
var UIController = (function () {
  ...
  return {
    getInput: function () {
      // Return the 3 items as object property to use them at once
      return {
...
var controller = (function (budgetCtrl, UICtrl) {
  var setupEventListeners = function () {
    ...
    document.querySelector(DOM.inputType).addEventListener("change", UICtrl.chanededType);
  };
  ...
  var ctrlDeleteItem = function (event) {
    ...
    if (itemID) {
      ...
      // Assign the first element in the splitID arr to var type
      type = splitID[0];
